...
export default class Game {
    ...
    private loadSkybox() {
        ...
        // Skybox
        const sphereTexture = new THREE.TextureLoader().load(basePath + '/assets/space.jpg');
    ...
    private loadBird() {
        ...
        this.loader.load(basePath + '/assets/phoenix_bird/scene.gltf', (gltf) => {
    ...
    private loadPipe() {
        this.loader.load(basePath + '/assets/sci-fi_pipes_armored/scene.gltf', (gltf) => {
    ...
    private loadFloor() {
        this.loader.load(basePath + '/assets/endless_floor_vr/scene.gltf', (gltf) => {
    ...
    private loadPortal() {
        this.loader.load(basePath + '/assets/triangular_animated_portal/scene.gltf', (gltf) => {
    ...
    private loadCrystal() {
        this.loader.load(basePath + '/assets/crystal_kyber/scene.gltf', (gltf) => {
    ...
    private async spawnPlanet() {
        ...
        // const texture = new THREE.TextureLoader().load(basePath + '/assets/space.jpg');
    ...
    private spawnBird2D() {
        const map = new THREE.TextureLoader().load(basePath + '/assets/flappy-bird/sprites/yellowbird-downflap.png');
